      ...
      <div className="border border-gray-300 shadow-custom rounded-custom m-3 p-2">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <img
              src={users.profilePicture ? process.env.REACT_APP_PUBLIC + users.profilePicture : process.env.REACT_APP_PUBLIC + '/person/noAvatar.png'}
              alt=""
        ...
        <div>
          <span>{post.desc}</span>
          <img src={process.env.REACT_APP_PUBLIC + post.img} alt="" className="mt-4"/>
        </div>
        <div className="flex justify-between mt-4">
          <div className="flex">
            <img src={ process.env.REACT_APP_PUBLIC +"/heart.png" }alt="" className="w-7 h-7" onClick={() =>handleLike()}/>
